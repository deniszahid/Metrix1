...
<html>
    ...
    .button2 {background-color: #008CBA; width: 100px;}
    .button3 {background-color: #f44336; width: 100px;}
    .button4 {background-color: #e7e7e7; color: black; width: 120px;}
    .button5 {background-color: #555555; width: 100px;}
    .button6 {visibility: hidden; width: 100px;}
    ...
    <br/>
          ...
          <section id="buttons">
                ...
                <div id="controls" class="control-container">
                  <table>
                  <tr><td align="center"><button class="button button6" id="get-still">Image</button></td><td align="center"><button id="toggle-stream">Старт</button></td><td></td></tr>
                  <tr><td></td><td align="center"><button class="button button2" id="forward" onclick="fetch(document.location.origin+'/control?var=car&val=1');">Вперед</button></td><td></td></tr>
                  <tr><td align="center"><button class="button button2" id="turnleft" onclick="fetch(document.location.origin+'/control?var=car&val=2');">Ліворуч</button></td><td align="center"></td><td align="center"><button class="button button2" id="turnright" onclick="fetch(document.location.origin+'/control?var=car&val=4');">Праворуч</button></td></tr>
                  <tr><td></td><td align="center"><button class="button button2" id="backward" onclick="fetch(document.location.origin+'/control?var=car&val=5');">Назад</button></td><td></td></tr>
                  <tr><td align="center"><button class="button button4" id="flash" onclick="fetch(document.location.origin+'/control?var=flash&val=256');">LED ON</button></td><td align="center"></td><td align="center"><button class="button button4" id="flashoff" onclick="fetch(document.location.origin+'/control?var=flashoff&val=0');">LED OFF</button></td></tr>
...
<head>
    ...
    <title>Перехід на іншу IP</title>
    <style>
        button {
            padding: 10px 20px;
            font-size: 16px;
...
<body>
        <button onclick="redirect()">Дані</button>

    <script>
        function redirect() {
            window.location.href = "http://192.168.4.2";
        }
    </script>
</body>
</html>
